...
....
#> ✔ Creating '/tmp/Rtmprxol4i/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmprxol4i/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|813c2eda2b… |rosericazondekon rosericazondekon@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmprxol4i/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.4.1/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmprxol4i/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmprxol4i/regexcite/README.Rmd'
----
