...
....
#> ✔ Creating '/tmp/RtmplGBnWh/regexcite/'
#> ✔ Setting active project to '/tmp/RtmplGBnWh/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|64af6889e2… |rosericazondekon rosericazondekon@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmplGBnWh/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.4.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmplGBnWh/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmplGBnWh/regexcite/README.Rmd'
----
