...
....
#> ✔ Creating '/tmp/Rtmpd5Qh4c/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmpd5Qh4c/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|2e0ece07d4… |rosericazondekon rosericazondekon@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpd5Qh4c/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.0/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpd5Qh4c/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmpd5Qh4c/regexcite/README.Rmd'
----
