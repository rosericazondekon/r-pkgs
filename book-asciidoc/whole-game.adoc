...
....
#> ✔ Creating '/tmp/RtmpmOX6pG/regexcite/'
#> ✔ Setting active project to '/tmp/RtmpmOX6pG/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|7c5d52ff94… |rosericazondekon rosericazondekon@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpmOX6pG/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.4.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpmOX6pG/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpmOX6pG/regexcite/README.Rmd'
----
