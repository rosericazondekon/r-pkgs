...
....
#> ✔ Creating '/tmp/RtmpYjIsKd/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpYjIsKd/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|181e76d39d… |rosericazondekon rosericazondekon@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpYjIsKd/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.4.2/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpYjIsKd/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpYjIsKd/regexcite/README.Rmd'
----
