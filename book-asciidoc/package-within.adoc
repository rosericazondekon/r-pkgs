...
#> [1] "2024-December-06_07-30-27_swim_clean.csv"
...
----
outfile_path("INFILE.csv")
#> [1] "2024-December-06_07-30-27_INFILE_clean.csv"

format(Sys.time(), "%Y-%B-%d_%H-%M-%S")
#> [1] "2024-December-06_07-30-28"
----
